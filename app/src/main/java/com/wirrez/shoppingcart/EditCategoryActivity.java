...
public class EditCategoryActivity extends MaterialDialog.Builder {
    ...
    public EditCategoryActivity(@NonNull final Context context, MaterialDialog.SingleButtonCallback posCallBack, MaterialDialog.SingleButtonCallback negCallBack) {
        super(context);
